...
All results will be stored in the corresponding results path inside a text file ```best-test-1-marginal0-mcmc0.txt``` (name corresponds the command line arguments used with ```test.py``` script).
